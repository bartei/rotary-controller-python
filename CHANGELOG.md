...
- Add link to Discord
  ([`cc1fd4a`](https://github.com/bartei/rotary-controller-python/commit/cc1fd4ac8b504dab409a7e89d21044c9e38531a0))
...
- Flake
  ([`1cf7c02`](https://github.com/bartei/rotary-controller-python/commit/1cf7c0250c8c3b0c760eee957e4d2dee21750d66))
...
- Testing flake with pi
  ([`1444105`](https://github.com/bartei/rotary-controller-python/commit/1444105dd4afd823ff922b15be826bbb9db35b0c))
...
- Testing flake with pi
  ([`ff4120f`](https://github.com/bartei/rotary-controller-python/commit/ff4120f5ec83497076869187e4a5b98d9ea9f571))

- Testing flake with pi
  ([`698578b`](https://github.com/bartei/rotary-controller-python/commit/698578bc25f00041be842d379a9266de1bf8f091))
...
- Move update event for statusbar in the statusbar code
...
- Remove data folder, not needed anymore
...
- Move network settings in the settings page
...
- Add form to configure circle pattern
...
- Remove unnecessary load of kv file for AppSettings
...
- Add num den value for each input
...
- Proper set coordinate conversion factors configured for X, Y and Z retrieved from the
